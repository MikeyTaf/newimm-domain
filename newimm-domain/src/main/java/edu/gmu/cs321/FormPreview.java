...
public class FormPreview extends Application {
            ...
            try {
                ...
                try {
                    ...
                    loader = new FXMLLoader(
                            FormPreview.class.getClassLoader().getResource("edu/gmu/cs321/NewImmigrantForm.fxml"));
                }
            }
    ...
    /**
     * Opens the Petition Detail view with real data if available, or mock data if
     * not
     */
            ...
            try {
                ...
                try {
                    ...
                    try {
                        // Method 3
                        loader = new FXMLLoader(
                                FormPreview.class.getClassLoader().getResource("edu/gmu/cs321/PetitionDetail.fxml"));
